...
+ (SVProgressHUD*)sharedView {
    ...
    dispatch_once(&once, ^{ sharedView = [[self alloc] initWithFrame:CGRectMake(0, 64, kMainScreenWidth, kMainScreenHeight)]; });
...
#endif
        _overlayView.frame = CGRectMake(0, 64, kMainScreenWidth, kMainScreenHeight);
