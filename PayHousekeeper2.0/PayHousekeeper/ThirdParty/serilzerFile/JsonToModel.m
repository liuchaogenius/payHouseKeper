...
//    SEL share = NSSelectorFromString([NSString stringWithFormat:@"share%@",name]);
//    if([tempclass instancesRespondToSelector:share])
//    {
//        object = [tempclass per];
//    }
//        
     object = [[NSClassFromString(name) alloc]init];
