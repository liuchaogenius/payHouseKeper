                 ...
                 inSession:(NIMSession *)session
{
    ...
    switch (sessionType) {
        ...
        case NIMSessionTypeTeam:
        {
            ...
            FriendsModel *model = [[DDFriendsInfoManager sharedInstance] getFriendInfo:userId];
            NSString *name = model?model.remarks:nil;
            if(name)
            {
                info.showName = name;
            }
            ...
            {
                name = [self nickname:user memberInfo:member];
                if (name)
                {
                    info.showName = name;
                }
    ...
    [[NIMSDK sharedSDK].userManager fetchUserInfos:userIds
                                        completion:^(NSArray *users, NSError *error) {
                                            ...
                                            if (!error) {
                                                ...
                                                if([YXManager sharedInstance].refreshConList)
