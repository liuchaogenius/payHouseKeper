...
//    UIImage * image = [UIImage nim_imageInKit:self.model.message.isOutgoingMsg?@"icon_sender_voice_playing.png":@"icon_receiver_voice_playing.png"];
//    _voiceImageView = [[UIImageView alloc] initWithImage:image];
//    NSArray * animateNames = self.model.message.isOutgoingMsg?@[@"icon_sender_voice_playing_001.png",@"icon_sender_voice_playing_002.png",@"icon_sender_voice_playing_003.png"]:@[@"icon_receiver_voice_playing_001.png",@"icon_receiver_voice_playing_002.png",@"icon_receiver_voice_playing_003.png"];
