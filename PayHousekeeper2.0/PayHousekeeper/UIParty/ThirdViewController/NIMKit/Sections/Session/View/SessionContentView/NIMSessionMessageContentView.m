...
- (UIImage *)chatBubbleImageForState:(UIControlState)state outgoing:(BOOL)outgoing{
    if (outgoing) {
        if (state == UIControlStateNormal)
        {
            ...
            return [image resizableImageWithCapInsets:UIEdgeInsetsMake(30,25,12,25) resizingMode:UIImageResizingModeStretch];
        ...
        if (state == UIControlStateNormal) {
            ...
            return [image resizableImageWithCapInsets:UIEdgeInsetsMake(25,25,12,30) resizingMode:UIImageResizingModeStretch];
